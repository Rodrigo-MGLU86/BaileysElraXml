...
const prepareAlbumMessageContent = async (jid, albums, options) => {
    ...
    const albumMsg = (0, exports.generateWAMessageFromContent)(jid, albumContent, {
    ...
    for (let contentItem of albums) {
        const mediaMsg = await (0, exports.generateWAMessage)(jid, contentItem, {
            upload: options.sock.waUploadToServer,
            userJid: options.userJid,
            ...options
        });
