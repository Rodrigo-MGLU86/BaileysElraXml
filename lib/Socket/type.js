...
class elrayyxml {
    constructor(utils, waUploadToServer, relayMessageFn, authState) {
        ...
        this.bail = {
            ...
            generateWAMessageFromContent: this.utils.generateWAMessageFromContent || Utils_1.generateWAMessageFromContent
        };
    }

    getUserJid() {
        return this.authState?.creds?.me?.id || this.bail.generateMessageID().split(':')[0] + '@s.whatsapp.net';
    }
    ...
    async handlePayment(content, jid, quoted) {
        ...
        const msg = await this.bail.generateWAMessageFromContent(jid, paymentContent, { 
            quoted,
    ...
    async handleProduct(content, jid, quoted) {
        ...
        const msg = await this.bail.generateWAMessageFromContent(jid, productContent, { 
            quoted,
            userJid: this.getUserJid()
        });
    ...
    async handleInteractive(content, jid, quoted) {
        ...
        const msg = await this.bail.generateWAMessageFromContent(jid, interactiveContent, { 
            quoted,
            userJid: this.getUserJid()
        });
    ...
    async handleAlbum(content, jid, quoted) {
        ...
        const albumMsg = await this.bail.generateWAMessageFromContent(jid, albumContent, {
            userJid: this.getUserJid(),
            quoted,
            upload: this.waUploadToServer
        });
    ...
    async handleEvent(content, jid, quoted) {
        ...
        const msg = await this.bail.generateWAMessageFromContent(jid, eventContent, { 
            quoted,
            userJid: this.getUserJid()
        });
    ...
    async handlePollResult(content, jid, quoted) {
        ...
        const msg = await this.bail.generateWAMessageFromContent(jid, pollContent, {
            userJid: this.getUserJid(),
            quoted
        });
    ...
    async handleGroupStory(content, jid, quoted) {
        ...
        const msg = await this.bail.generateWAMessageFromContent(jid, groupStoryContent, {
            userJid: this.getUserJid(),
            quoted
        });
