            ...
            if (typeof content === 'object' &&
              ...
              const albumMsg = await Utils_1.prepareAlbumMessageContent(jid, content.album, {
                ...
                for (const media of albumMsg) {
            		...
            		await relayMessage(jid, media.message, { messageId: media.key.id, useCachedGroupMetadata: options.useCachedGroupMetadata, additionalAttributes, statusJidList: options.statusJidList, additionalNodes: options.additionalNodes })
            	}
            return albumMsg;
            }
            else {
